...
let [nameSt, skills,, ] = student1
let [,,jsScore, reactScore] = student1[2]
// console.log(nameSt + ' - ' + skills + ' - JSScore: ' + jsScore + ' - ReactScore: ' + reactScore)
const student2 = [
...
// console.log(convertArrayToObject(student2))
const student3 = {
    name: 'David',
    age: 25,
    skills: {
