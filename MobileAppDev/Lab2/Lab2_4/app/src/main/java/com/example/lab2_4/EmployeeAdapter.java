...
public class EmployeeAdapter extends ArrayAdapter<Employee> {
    ...
    public EmployeeAdapter(Activity context, int layoutID, List<Employee> obj)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        // Get view
        TextView tvFullName = (TextView) convertView.findViewById(R.id.employee_fullname);
        TextView tvPosition = (TextView) convertView.findViewById(R.id.employee_position);
        ImageView ivManager = (ImageView) convertView.findViewById(R.id.item_manager);
        LinearLayout llParent = (LinearLayout) convertView.findViewById(R.id.ll_parent);
        // Set fullname
